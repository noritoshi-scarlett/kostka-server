$(document).ready(function() {
  ...
  function checkRoll(link, json) {
    if (window.location.pathname.indexOf("posting") != -1) {
        link.parent().before(
                $('<div class="dice-before-test">').append(
                    $('<div style="text-align: center">').text(textCorrectDiceRollinPosting)
                )
        );
        return;
    }
  ...
  if (window.location.pathname.indexOf("topics") != -1 || window.location.pathname.indexOf("viewtopic") != -1) {
	...
	if (isNewTopic) {
        ...
        var dice_date_storage = "",
            dice_link_storage = "",
            dice_topic_storage = "",
            dice_date_last_storage = "",
            dice_link_last_storage = "",
            dice_topic_last_storage = "",
            dice_date_manual_storage = "",
            dice_link_manual_storage = "",
            dice_topic_manual_storage = "";
